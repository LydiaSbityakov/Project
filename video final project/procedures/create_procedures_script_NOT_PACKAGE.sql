create or replace procedure find_available_copy_id(
...
-- THIS UPDATE STATEMENT CAN BE REPLACED BY TRIGGER
-- up date status
update title_copy
set status = v_status
...
-- THIS UPDATE CAN BE REPLACED WITH TRIGGER
...
-- get title id and check if there are any reservations for this title
get_reservation_info(v_copy_id, v_title_name, v_member_fname, 
